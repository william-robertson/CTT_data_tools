...
##
##    
##    Adjusted Paxton code! - Will Robertson
##    
##
##    Adjusted error code to bring in beep data from specific time range used for 1st error assessment of calibration 1
##    Time range is telemetry 06/10/2024-07/08/2024
##
##    Files Needed
...
##
##        2. Tags_et1.csv file with a list of all tags on turtles during specified time range + calibration tags
...
outpath <- "C:/pg_Data/calibation_beepdata/"  #might want to change this so that RDS files all get stored in one folder on one drive and not the local disk
...
tags <- read.csv("Tags_et1.csv", header = T) 
